...
# Fix Chunk 1: Bracket indentation/residue in Section 1
content = content.replace("            image: '/photo/1/スクリーンショット1-3 2026-03-18 145141.png',\n                    }", "            image: '/photo/1/スクリーンショット1-3 2026-03-18 145141.png',\n          }")

# Fix Chunk 2: The huge mess from line 266 to 736 (the start of Admin)
# I will find the start of Section 2.2 and the start of Section 5 (Admin)
# and replace everything in between.

start_marker = "{ id: 'material-input'," # This was around line 267
end_marker = "id: SectionType.ADMIN," # This is around line 737

start_idx = content.find(start_marker)
end_idx = content.find(end_marker)

if start_idx != -1 and end_idx != -1:
    # Back up to the opening brace of Section 2.2's page
    start_point = content.rfind("{", 0, start_idx)
    # Go back a bit more to ensure we catch indentation
    start_point = content.rfind("\n", 0, start_point) + 1
    
    # End point should be just before SectionType.ADMIN opening brace
    end_point = content.rfind("{", 0, end_idx)
    end_point = content.rfind("\n", 0, end_point) + 1
    ...
    section2_2_3_4 = """      {
        ...
        title: {
          ...
          ne: 'सामग्री डिस्चार्ज/इनपुट रेकード दर्ता गर्नुहोस्'
        },
        content: {
    ...
    pages: [
      {
        ...
        content: {
          ...
          vi: 'Chọn những gì cần làm hôm nay and bắt đầu.',
          pt: 'Selecione o que fazer hoje and comece.',
          tl: 'Piliin ang gagawin ngayong araw and magsimula.',
          id: 'Pilih apa yang akan dibuat hari ini dan mulai.',
        ...
        steps: [
          {
            ...
            description: {
              ...
              vi: 'Nhấn "Tìm kiếm" and chạm vào sản phẩm bạn sẽ làm hôm nay từ danh sách.',
          ...
          },
          {
            ...
            description: {
              ...
              ne: 'स्क्रिनको तल रहेको नीलो "नतिजा इनपुट" बटन ट्याप गर्नुहोस्।'
            },
          ...
          },
          {
            ...
            description: {
              ...
              vi: 'Chọn khung giờ hiện tại (Ca A, Ca B, v.v.) and nhấn "Xác nhận" để bắt đầu ghi chép.',
        ...
        steps: [
          ...
          },
          {
            ...
            description: {
              ...
              tl: 'I-switch ang button sa ibabang kaliwa ng screen ayon sa uri ng kahon na iyong ginagamit (Regular o Pansamantala).',
...
"""
    new_content = content[:start_point] + section2_2_3_4 + content[end_point:]
